...
```bash
# 随机生成地图（用于训练数据增强）
python3 scripts/random_create_map.py

# URDF 日志转 C++ 格式
python3 scripts/change_data.py <input_log> <output_txt>

# 调试图像转数据集
python3 scripts/change_debug_to_data.py
```
...
### 5.4 world_ws8 — set_box_lists 重构版
...
### 5.9 world_ws13 — BaseMoveController 重构版
...
### 5.10 world_ws13.5 — 地图数据更新与最终优化版
