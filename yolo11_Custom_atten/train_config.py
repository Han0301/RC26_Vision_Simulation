...
train_config = {
    ...
    "MODEL_NAME": "yolo11n_roi12_atten_8.pt",
...
model_config_2 = {
    ...
    "NUM_CLASSES": 2,  # 分类数
    "MODEL_SIZE": "n",  # 模型尺寸
    "YOLO_weight_path": "H:\pycharm\yolov11\yolov11.pt\yolo11n.pt"  # 加载YOLO预训练权重的路径,尺寸要和模型尺寸一致
}
...
train_config_2 = {
    ...
    # RESUME_TRAIN = False, 从头训练
    "SAVE_DIR": "./yolo11_pt",  # 输出的模型路径
    "MODEL_NAME": "yolo11n_roi12_atten_9.pt",
    # RESUME_TRAIN = True, 加载之前的模型继续训练
    "CHECKPOINT_PATH": r"./yolo11_pt/yolo11s_roi12_ps_6.pt"  # 之前保存的模型路径
}
...
dataset_config_3 = {
    ...
    "DATASET_ROOTS": [  # 数据集路径
        r"H:\pycharm\yolov11\yolov11_proj3\yolo11Custom_pointsize\test\mini_datasets_3066\datasets_1",
        r"H:\pycharm\yolov11\yolov11_proj3\datasets_real_p179"
    ],
    "VAL_RATIO": 0.2,  # 验证集的占比
    # load_datasets = False 指定数据集和验证集
    "TRAIN_DATASETS": [r"H:\pycharm\yolov11\yolov11_proj1\datasets_16334"],
...
train_config_3 = {
    ...
    # RESUME_TRAIN = False, 从头训练
    "SAVE_DIR": "./yolo11_pt",  # 输出的模型路径
    "MODEL_NAME": "yolo11n_roi12_atten_10.pt",
    # RESUME_TRAIN = True, 加载之前的模型继续训练
    "CHECKPOINT_PATH": r"./yolo11_pt/yolo11s_roi12_ps_6.pt"  # 之前保存的模型路径
}
...
train_config_4 = {
    ...
    # RESUME_TRAIN = False, 从头训练
    "SAVE_DIR": "./yolo11_pt",  # 输出的模型路径
    "MODEL_NAME": "yolo11n_roi12_atten_11.pt",
    # RESUME_TRAIN = True, 加载之前的模型继续训练
    "CHECKPOINT_PATH": r"./yolo11_pt/yolo11s_roi12_ps_6.pt"  # 之前保存的模型路径
}
...
train_config_5 = {
    ...
    # RESUME_TRAIN = False, 从头训练
    "SAVE_DIR": "./yolo11_pt",  # 输出的模型路径
    "MODEL_NAME": "yolo11n_roi12_atten_12.pt",
    # RESUME_TRAIN = True, 加载之前的模型继续训练
    "CHECKPOINT_PATH": r"./yolo11_pt/yolo11s_roi12_ps_6.pt"  # 之前保存的模型路径
}